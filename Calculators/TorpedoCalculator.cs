...
public static class TorpedoCalculator
{
    ...
    /// </summary>
    private static void CalculateAndStorePerformanceValues(Dictionary<string, object> torpedoData,
        NavalEquipment equipment)
    {
        try
        {
            // パラメータを取得
    ...
    private static void SaveToDatabase(NavalEquipment equipment, Dictionary<string, object> torpedoData)
    {
        try
        {
            ...
            // 射程
            addStats.NavalRange =
                Convert.ToDouble(equipment.AdditionalProperties["CalculatedRange"]) * 100; // km → 100km単位
