    ...
    public static class RadarCalculator
    {
        ...
        public static NavalEquipment Radar_Processing(Dictionary<string, object> rawRadarData)
        {
            try
            {
                ...
                var electronics = rawRadarData.ContainsKey("Electronics") ? Convert.ToDouble(rawRadarData["Electronics"]) : 0;
                ...
                var isFireControl = rawRadarData.ContainsKey("IsFireControl") && Convert.ToBoolean(rawRadarData["IsFireControl"]);
                ...
                var isAllWeather = rawRadarData.ContainsKey("IsAllWeather") && Convert.ToBoolean(rawRadarData["IsAllWeather"]);
                ...
                // 特殊能力の設定
                if (is3D || isDigital || isDoppler || isLongRange || isFireControl || isStealth || isCompact || isAllWeather)
                {
