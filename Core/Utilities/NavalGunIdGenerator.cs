...
public static class NavalGunIdGenerator
{
    ...
    public static string GenerateGunId(string category, int year, double caliber, string caliberUnit,
        double barrelLength)
    {
    ...
    /// <param name="caliberUnit">
    ///     抽出される口径単位
    ///     ///
    ///     <param name="barrelLength">抽出される砲身長</param>
    ///     <returns>パラメータの抽出に成功したかどうか</returns>
    public static bool TryParseGunId(string id, out string category, out int year, out double caliber,
