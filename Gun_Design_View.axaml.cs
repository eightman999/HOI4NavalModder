...
public Gun_Design_View(Dictionary<string, object> rawGunData, Dictionary<string, NavalCategory> categories,
  ...
  private void InitializeUIOptions()
        ...
        // External Gun_Processing class/method will be used instead of implementing the calculation here
        // This class is in a separate file

        // Fixed method name to match what's in the XAML
