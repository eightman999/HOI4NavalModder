...
namespace HOI4NavalModder
{
    public partial class CategorySelectionWindow : Window
    {
        ...
        private Dictionary<string, NavalCategory> _categories;
        private Dictionary<int, string> _tierYears;
        ...
        public CategorySelectionWindow(Dictionary<string, NavalCategory> categories, Dictionary<int, string> tierYears)
        {
            ...
            {
                _categoryComboBox.Items.Add(new NavalCategoryItem { Id = category.Key, DisplayName = $"{category.Value.Name} ({category.Key})" });
            }
